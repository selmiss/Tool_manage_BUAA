<template>
  <div style="width:100%;display: grid;grid-template-rows: 40px auto;row-gap: 30px;">
    <div style="display: grid;grid-template-columns: 20% 40% 40%;align-items: center">
      ...
      <span>
        <el-input style="width: 400px;margin-left:100px;" placeholder="支持模糊搜索工具名称" v-model="searchkey"
    ...
    <div
      ...
      <div class="tagselect-onetag" v-for="tool in tools" @click="chooseTool(tool)">
        ...
        <div style="height: 40px;width: 160px;margin-top:10px;display:inline-block;">
          <el-button size="small" style="margin-top:5px;" @click="ToolInfo(tool)">详情</el-button>
          <el-button type="primary" size="small" style="margin-top:5px;" @click="borrowTool(tool)">借用</el-button>
        </div>
      </div>


      <el-dialog v-model="dialogVisible" center :modal=true :append-to-body=true width="700px" top="5px">
            ...
            <el-form ref="thetool" :model="thetool" :rules="rules" style="margin-top:3vh;line-height: 50px"
              ...
              <el-form-item label="借用时间" prop="duration">
                <el-date-picker v-model="thetool.duration" type="daterange" range-separator="至"
                  start-placeholder="开始借用日期" end-placeholder="归还日期" @change="changeDuration">
                </el-date-picker>
              ...
              <el-form-item label="借用理由" prop="purpose">
                <el-input type="textarea" :rows="2" style="width: 300px" placeholder="请输入内容" v-model="thetool.purpose">
                </el-input>
              </el-form-item>
