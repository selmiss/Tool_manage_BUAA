      ...
      <el-main width="75%">
        ...
        <div style="margin: 0 auto; margin-top: 20px; align-items: center;">
          <el-card class="box-card" style="width: 100%">
            <el-table :data="renewList" style="width: 100%" border>
              ...
              <el-table-column align="center" label="操作" min-width="200">
                <template #default="scope">
                  <el-popover trigger="click" placement="left" width="250">
                    <template #default>
                  ...
                  <el-button size="mini" type="success" plain @click="handleAgree(scope.row)">同意</el-button>
                  <el-button size="mini" type="danger" plain @click="handleCreate()">拒绝</el-button>
                  <el-dialog v-model="dialogFormVisible">
                    <el-form :model="formData" ref="dataForm" label-position="left" label-width="80px"
                      style="width: 300px; margin-left:50px;">
                      <el-form-item label="拒绝原因">
                        <el-input type="textarea" :rows="2" v-model="formData.refuseReason"
